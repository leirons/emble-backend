(function () {
  ...
  const TRANSLATIONS = {
    uk: {
      ...
      contacts_desc: 'Напишіть у Telegram, зателефонуйте або надішліть email — відповімо швидко та допоможемо із запуском ШІ чат-бота.',
      contact_tg: 'Telegram',
    ...
    ru: {
      ...
      contacts_desc: 'Напишите в Telegram, позвоните или отправьте email — ответим быстро и поможем с запуском ИИ чат-бота.',
      contact_tg: 'Telegram',
      contact_phone: 'Телефон',
      contact_email: 'Email',
