(function () {
  ...
  const TRANSLATIONS = {
    uk: {
      ...
      faq_q3: 'Чи спілкується чат-бот українською мовою?',
      faq_a3: 'Так. Бот автоматично визначає мову покупця і відповідає нею — українською, англійською чи будь-якою іншою. Уся панель керування також доступна українською.',
    ...
    ru: {
      ...
      faq_q3: 'Общается ли чат-бот на украинском языке?',
      faq_a3: 'Да. Бот автоматически определяет язык покупателя и отвечает на нём — на украинском, английском или любом другом. Вся панель управления также доступна на украинском.',
